 ...
 * @param {{onCreated?: (user: IUser) => Promise<void>, onRollback?: (user: IUser) => Promise<void>}} [lifecycle={}] Trusted server-only lifecycle hooks.
 * @returns {Promise<{status: number, message: string, userCreated?: boolean}>}
 */
